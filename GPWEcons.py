...
class Refinery(object):
    """A refinery with the following standard attributes:
            refinery_volume: size of CDU
            lvn_gasolinepool: the cut of lvn into gasoline pool
            kero_gasolinepool: the cut of kero into gaosline pool
            reformer_capacity: volume of the reformer
