...
import pandas as pd
from arb_model import import_data
from arb_model import arb
from gpw_model import gpw_calculation
...
writer = pd.ExcelWriter('L://TRADING//ANALYSIS//Python//GlobalArbs_FINAL_CHECK3.xlsx')
